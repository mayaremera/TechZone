...
export default function Gaming() {
  ...
  // Fetch products for Gaming Consoles category (ID 2)
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch("http://localhost:8080/categories/2", {
          headers: {
        ...
        console.log("Formatted products:", formattedProducts.map(p => ({ name: p.name, category: p.category })));
