...
export default function Smartphones() {
  ...
  // Fetch products for Smartphones category (ID 3)
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch("http://localhost:8080/categories/3", {
          headers: {
